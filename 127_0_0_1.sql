...
--
-- Хост: 127.0.0.1
-- Время создания: Июн 12 2020 г., 12:25
...
(1, 'Иван', '83485893', '47560372', 'imagas/user_male.webp', ''),
(2, 'Катя', '438460235', '94893453620', 'imagas/user2.webp', ''),
(3, 'Хомка', '83485893', '47560372', 'imagas/user_male.webp', ''),
(4, 'Вика', '543556', 'vi@.com', '', '12345'),
(6, 'Катя', '', 'fdfdf', '', 'fhh'),
(8, 'Юля', '', 'wo@.com', '', '5555555'),
(9, 'Женя', '', 'wo@.com', '', '5555555'),
(10, 'Вася', '', 'dfddfdf', '', 'fgretg'),
(11, 'Виктор', '', 'dfddfdf', '', 'fgretg'),
(12, 'Кирил', '', 'dfddfdf', '', 'fgretg'),
(13, 'Юра', '', 'dfddfdf', '', 'fgretg'),
(14, 'Linc', '', 'Linc', '', '123');

-- --------------------------------------------------------

--
-- Структура таблицы `soobhenya`
--

CREATE TABLE `soobhenya` (
  `text` text NOT NULL,
...
--
-- Дамп данных таблицы `soobhenya`
--

INSERT INTO `soobhenya` (`text`, `time`, `id`, `komu_polzovatel_id`, `ot_polzovatel_id`) VALUES
('Привет', '2020-06-05 14:14:52', 15, 1, 3),
('да привет', '2020-06-05 14:14:52', 16, 3, 1),
('Как дела?', '2020-06-05 14:14:52', 17, 3, 1),
('Привет', '2020-06-10 15:14:27', 18, 1, 3),
('df', '2020-06-11 14:44:08', 34, 2, 1),
('df', '2020-06-11 14:45:20', 35, 1, 0),
('we', '2020-06-11 14:45:30', 36, 1, 0),
('we', '2020-06-11 14:46:12', 37, 1, 0),
('jjjj', '2020-06-12 12:01:02', 74, 1, 14),
('zz', '2020-06-12 12:03:31', 75, 1, 14),
('zz', '2020-06-12 12:04:57', 76, 1, 14),
('zz', '2020-06-12 12:05:06', 77, 1, 14),
('sd', '2020-06-12 13:00:03', 78, 1, 14),
('sdgg', '2020-06-12 13:00:46', 79, 1, 14),
('sddf', '2020-06-12 13:04:49', 80, 3, 14);
...
--
-- Индексы таблицы `soobhenya`
--
ALTER TABLE `soobhenya`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT для таблицы `soobhenya`
--
ALTER TABLE `soobhenya`
...
('root', '[{\"db\":\"chat\",\"table\":\"polzovateli\"},{\"db\":\"chat\",\"table\":\"soobhenya\"}]');
...
('root', 'chat', 'polzovateli', '[]', '2020-06-05 10:51:36'),
('root', 'chat', 'soobhenya', '{\"sorted_col\":\"`ot_polzovatel_id` ASC\"}', '2020-06-12 08:59:21');
...
('root', '2020-06-12 10:04:56', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"ru\"}');
